...
function Navbar() {
  ...
  return (
    <nav className="z-[999] sticky bg-white dark:bg-navy flex flex-row justify-center text-navy dark:text-white items-start px-4 py-2 sm:py-0 w-full shadow-md shadow-lightnavy rounded-b-[2rem]">
      <div className="flex flex-col sm:flex-row w-10/12">
        <Link
          to="/"
          className="text-sm sm:text-md text-navy dark:text-white bg-white dark:bg-navy sm:py-4 "
        >
          <b>AUNYAPAT</b>
        </Link>
        ...
        >
          ...
          >
            ...
            <Link to="/profile" className="text-sm sm:text-md">
          ...
          >
            {/* Replace href with to */}
            <Link to="/projects" className=" text-sm sm:text-md">
              <p className="border-b-2 border-lightnavy hover:border-navy">
                PROJECTS
              </p>
            </Link>
