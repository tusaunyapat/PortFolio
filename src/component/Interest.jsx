...
function Interest() {
  ...
  return (
    <div className="flex justify-center  bg-lightgray dark:bg-navy mt-50 py-32">
      <div className="flex flex-col justify-center items-center py-6 h-full sm:h-96  text-navy dark:text-white w-full lg:w-10/12">
        ...
        <div className="flex flex-wrap flex-col sm:flex-row py-6 w-full justify-center items-center">
          {data.map((item) => (
            <div
              key={item.id}
              className="flex flex-col px-4 justify-center items-center mx-5 border-2 rounded-2xl my-4 w-6/12 sm:w-3/12 "
              id={item.id}
            >
